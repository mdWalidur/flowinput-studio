  ...
  head: () => ({
    meta: [
      ...
      { title: "FlowInput — Input anything. Get what you need." },
      {
        name: "description",
        content:
          "Transform notes, documents and rough ideas into Markdown, study packs, AI context, product specs or optimized prompts.",
      },
      { property: "og:title", content: "FlowInput" },
      {
        property: "og:description",
        content: "Input anything. Get what you need.",
      },
